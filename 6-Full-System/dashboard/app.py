"""
NYC Taxi — Full System Dashboard (Module 6)
...
Four tabs:
  ...
  Tab 4 — System         Health of all services + retrain instructions
        ...
        if not alerts.empty:
            ...
            for _, row in alerts.iterrows():
                with st.expander(f"{row['period']} — MAE {row['mae']:.2f} min "
                    ...
                    st.info("Model degradation detected → see **System & Retrain** tab")
